...
export const Calculator = ({
    ...
    const handleControls = ({
        ...
        if (value === "clear") {
            if (quill) {
                quill.setContents([]); /* Clear the contents ???  */
                quill.focus();
            }
            return null;
        }
        ...
        if (value === "sqrt") {
            if (quill) {
                const selection = quill.getSelection();
                const index = selection && selection.index;
                const length = selection && selection.length;
    ...
    return (
        <div className="panel">
            <div
                className={`${darkMode ? "panel__input panel__input__dark-mode" : "panel__input"}`}
            >
                <div ref={quillRef} />
