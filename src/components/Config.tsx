...
export const Config = ({
    ...
    const handlePrecisionChanges = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        <div className={classNameString()}>
            ...
            <div className="config__main">
                ...
                <hr
                    className={`${darkMode ? "horizontal-rule__dark-mode" : "horizontal-rule"}`}
                />

                <div className="config__main__option config__main__dark-mode">
                    <div className="config__main__option__label">
                        Dark Mode:{" "}
                    </div>
