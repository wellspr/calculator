...
// Constants
const pi = (precision: number) => {
    return {
        icon: <Pi />,
        value: math.round(math.pi, precision),
        operator: "pi",
        className: "pi",
    };
};

const euler = (precision: number) => {
    return {
        icon: <Euler />,
        value: math.round(math.e, precision),
        operator: "euler",
        className: "euler",
    };
};
...
const Controls = ({
    ...
    handleControls: ({ value, operator }: { value: string; operator: string }) => void;
    precision: number;
    darkMode: boolean;
}) => {
    return (
